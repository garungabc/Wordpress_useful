...
<style type="text/css">
	...
	.contact .breadcrumb li a.active {
	    color: #d55449;
	...
	<div class="row">
		<div id="ctl00_divCenter" class="middle-fullwidth col-sm-12">
			<div class="clearfix contact-wrap">
				<div class="row">
					<div class="col-sm-12 col-xs-12 Module Module-54">
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 mrb20 Module Module-53">
						...
						<h2>1. Liên hệ với Phòng Hành chính nhân sự</h2>

						<p>Phụ trách: Lê Văn A</p>

						<p>Email: A@vmms.com.vn</p>

						<p>SĐT: 04 123 4567</p>
						<br>

						<h2>2. Liên hệ với Phòng Kỹ thuật</h2>

						<p>Phụ trách: Trần Văn B</p>

						<p>Email: B@vmms.com.vn</p>

						<p>SĐT: 04 123 4567</p>
						<br>

						<h2>3. Liên hệ với Phòng Kinh doanh</h2>
						<p>Phụ trách: Trần Phương C</p>

						<p>Email: C@vmms.com.vn</p>
					...
					<div class="col-md-4 col-sm-6 text-center mrb20 Module Module-147">
						<div class="ModuleContent">
							<img alt="" width="339" height="456" src="http://fakeimg.pl/339x456">
						</div>
					</div>
				</div>

				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 mrb20 Module Module-148">
						<div class="ModuleContent">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.29003345919!2d105.81594531443692!3d21.02107798600251!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab7aba3cad95%3A0x4de4508f754d58cd!2zMjMgTMOhbmcgSOG6oSwgVGjDoG5oIEPDtG5nLCBCYSDEkMOsbmgsIEjDoCBO4buZaSwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1494299323933" width="100%" height="350" frameborder="0" style="border: 0px;">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 mrb20 Module Module-149">
						<div class="ModuleContent">
							<h2>Công ty Cổ phần Dịch vụ Truyền thông Đa phương tiện Việt Nam (Vietnam Multimedia Services., JSC)</h2>

							<p>Địa chỉ: Phòng 107, Tòa nhà CFM, 23 Láng Hạ, Ba Đình, Hà Nội</p>

							<p>VPGD: Địa chỉ: Phòng 107, Tòa nhà CFM, 23 Láng Hạ, Ba Đình, Hà Nội</p>

							<p>TEL: +84-43-1234567  </p>

							<p>FAX: +84-43-1234567 </p>

							<p>EMAIL: info@vmms.com.vn</p>
						</div>
					</div>
				</div>
